...
为实现腾讯 SDK 的视频播放功能，我们可能需要向第三方开发者和/或终端用户收集相关个人信息。以下将详细列出腾讯 SDK 的各项业务功能及为实现该功能所需收集的个人信息情况。
...
| 操作系统类型   | 用于在播放质量监控界面上显示操作系统类型                        |
| 网络信息      | 用于在播放质量监控界面上显示用户网络信息                        |
| 运营商        | 用于在播放质量监控界面上显示用户运营商                          |
| 浏览器        | 用于在播放质量监控界面上显示用户浏览器                          |
| 系统语言类型   | SDK内部处理文字时使用                             |
| 屏幕分辨率     | SDK内部进行渲染适配时使用                       |
